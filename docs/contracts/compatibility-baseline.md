...
- `quality-gate.yml`
  ...
  - PR and `main` pushes prefer the local docs preview when it exists so repo CI remains hermetic and audits the checked-in surface, not the last deployed Pages revision
